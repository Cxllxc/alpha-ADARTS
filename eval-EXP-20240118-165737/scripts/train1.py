...
parser.add_argument('--data', type=str, default=r'/opt/data/private/zyx/scripts0/data/datasets/cifar-100', help='location of the data corpus')
parser.add_argument('--set', type=str, default='cifar10', help='location of the data corpus')
parser.add_argument('--batch_size', type=int, default=272, help='batch size')
parser.add_argument('--learning_rate', type=float, default=0.12, help='init learning rate')
